        ...
        <div className='parentModalEdit'>
           <div className='editPostComponent'>
            <p className='editPostTitle'>Edit Post</p>
              <textarea onChange={(e)=>authDispatch({type:'editedContent', payload:e.target.value})}  className='textArea'></textarea>
        
             <div className='editPostComponentFooter'>
                  <span className='photo-icon'><BsImageFill /></span>
                  <button onClick={()=>editPostFunc()}  className='editPost-btn'>Post</button>
             </div>
